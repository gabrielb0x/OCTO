...
SCENES=(welcome home chat sidebar voice settings settingsApp subscription about developer network deleteToast freePlan lightChat messageDetails whatsNew)
